...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/densenet121_e_p02process.png}\label{fig:densenet121_e_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=80mm]{./fig/result0.png}\label{fig:0}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/densenet121_e_p02threshold.png}\label{fig:densenet121_e_result_threshold}} \quad
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/resnet3dprocess.png}\label{fig:resnet3d_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/resnet3dthreshold.png}\label{fig:resnet3d_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{3D-ResNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/densenet121process.png}\label{fig:densenet121_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/densenet121threshold.png}\label{fig:densenet121_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{DenseNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/densenet161process.png}\label{fig:densenet161_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/densenet161threshold.png}\label{fig:densenet161_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{DenseNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/densenet161_eprocess.png}\label{fig:densenet161_e_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/densenet161_ethreshold.png}\label{fig:densenet161_e_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{DenseNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/resnet3d_eprocess.png}\label{fig:resnet3d_e_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/resnet3d_ethreshold.png}\label{fig:resnet3d_e_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{3D-ResNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/resnet3d_mprocess.png}\label{fig:resnet3d_m_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/resnet3d_mthreshold.png}\label{fig:resnet3d_m_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{3D-ResNetを用いた内視鏡画像からのマルチラベル予測}
...
\begin{figure}[tb]
    \centering
        \subfloat[][学習過程]{\includegraphics[width=130mm]{./fig/resnet3d_e_mprocess.png}\label{fig:resnet3d_e_m_result_process}} \quad
        %\subfloat[][検証結果]{\includegraphics[width=70mm]{./fig/sample2.jpg}\label{fig:02}} \quad
        \subfloat[][各しきい値におけるテスト]{\includegraphics[width=130mm]{./fig/resnet3d_e_mthreshold.png}\label{fig:resnet3d_e_m_result_threshold}} \quad
        %\subfloat[][推論結果]{\includegraphics[width=70mm]{./fig/sample4.jpg}\label{fig:04}} \quad
    \captionsetup{format=plain,font=normalsize,margin=30pt,name=図}
    \caption[]{3D-ResNetを用いた内視鏡画像からのマルチラベル予測}
